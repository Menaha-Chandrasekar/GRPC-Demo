...
type CustomerServiceClient interface {
	GetCustomer(ctx context.Context, in *Task, opts ...grpc.CallOption) (*TaskResponse, error)
}
...
func (c *customerServiceClient) GetCustomer(ctx context.Context, in *Task, opts ...grpc.CallOption) (*TaskResponse, error) {
...
type CustomerServiceServer interface {
	GetCustomer(context.Context, *Task) (*TaskResponse, error)
...
func (UnimplementedCustomerServiceServer) GetCustomer(context.Context, *Task) (*TaskResponse, error) {
...
func _CustomerService_GetCustomer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CustomerServiceServer).GetCustomer(ctx, req.(*Task))
	}
